...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\subsection{Flip}\label{Flip For Perfect Binary Trees}
...
\begin{lemma}[$flip_\mathcal{K}$ is a bijective involution]
...
\begin{lemma}
  Let $T$ be a perfect binary tree and $\mathcal{V}_k$ be the depth vertex set of depth $k$. Then, the flip function $flip_\mathcal{K}$ maps independent sets into independent sets and induces a bijection from $\mathcal{I}^m_{\mathcal{V}_k}$ onto itself. 
...
The flip function for paths maps independent sets into independent sets if we can procure a similar result to ~\cite{MR4245360} to show that our flip function induces a one to one mapping from any vertex $v \in V(T)$ such that $\mathcal{I}_T(V)$ into a leaf $l \in V(T)$, then we will be able to show that the HK-property holds for perfect binary trees. 
